...
if __name__ == '__main__':
    ...
    parser.add_argument("--config", type=str, default="/home/eliothluy/Documentos/artigoJussi/ns-o-ran-gym/src/environments/scenario_configurations/ts_use_case.json",
